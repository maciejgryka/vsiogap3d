...
//    				return true;
	    		...
	    		if(resX <  resY) {	
	    			if (resY < 5) return true;
	    			if(startY > endY) {
	    				//mGLThread.changePanY(0.1f);
	    				mGLThread.changeElevation(-1);
	    			} else {
	    				//mGLThread.changePanY(-0.1f);
	    				mGLThread.changeElevation(1);
	    			}
	    		} else {
	    			if (resX < 5) return true;
	    			if(startX>endX) {
	    				//mGLThread.changePanX(-0.1f);
	    				mGLThread.changeRotation(-1);
	    			} else {
	    				//mGLThread.changePanX(0.1f);
	    				mGLThread.changeRotation(1);
	    			}
	...
	{
		startX = startY = endX = endY = resX = resY = 0;
//		startY = 0;
//		endX = 0;
//		endY = 0;
//		resX = 0;
...
//        	mRenderer.changeDistance(distance);
//        }
